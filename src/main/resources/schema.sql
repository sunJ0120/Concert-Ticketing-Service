...
INSERT INTO venues (name, address, total_seats)
VALUES ('올림픽공원 체조경기장', '서울특별시 송파구 올림픽로 424', 15000),
       ('고척스카이돔', '서울특별시 구로구 경인로 430', 20000),
       ('잠실실내체육관', '서울특별시 송파구 올림픽로 25', 11000);

INSERT INTO sections (venue_id, name, base_price, color, row_count, seats_per_row)
VALUES (1, 'VIP', 220000, '#FFD700', 2, 12),
...
INSERT INTO concerts (venue_id, title, artist, concert_date, concert_time, booking_start_at,
                      booking_end_at, status)
VALUES (1, 'IU Concert: The Golden Hour', 'IU', '2025-03-15', '19:00:00', '2025-01-15 20:00:00',
        '2025-03-15 18:00:00', 'BOOKING'),
       (1, 'BTS Yet To Come', 'BTS', '2025-04-20', '18:00:00', '2025-02-20 20:00:00',
        '2025-04-20 17:00:00', 'SCHEDULED');
